...
import { PuzzlePieceIcon, ChatBubbleLeftRightIcon, ChartBarIcon, SparklesIcon } from '@heroicons/react/24/outline';
  ...
  <section className="py-20 px-8 bg-indigo-900/30 text-center text-white">
    ...
    <div className="grid md:grid-cols-2 gap-10 max-w-4xl mx-auto">
      {features.map((feature, index) => (
        <div key={index} className="bg-white/10 p-8 rounded-xl backdrop-blur-sm text-left flex flex-col items-center transform hover:scale-105 transition-transform duration-300">
